         ...
         <div class="struktur">
            <div class="orang">
               <img
                  ...
                  sizes="200px"
                  />
               <h6 class="nama">Nico Cristian</h6>
               <p class="jabatan">Ketua HIMBISDI</p>
               <p class="jabatan2"></p>
               <div class="struktursocials">
                  <a href="https://www.instagram.com/crisxcoo/" target="_blank">
                  <i img decoding="async" data-feather="instagram"></i>
                  <a href="https://www.linkedin.com/in/nicocristian/" target="_blank">
                  <i img decoding="async" data-feather="linkedin"></i>
                  </a>
               </div>
            </div>
            <div class="orang">
