...
if (!isset($_SESSION['nama'])) {
    echo '<script>alert("Anda belum login. Silakan login terlebih dahulu!"); location.href = "../login.php";</script>';
    exit;
}
?>
<!DOCTYPE html>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                else if($menu == "admin") { include "admin.php"; }
                else if($menu == "pengurus") { include "pengurus.php"; }
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>&copy; Created by Departemen DIGIPRENEUR.</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
